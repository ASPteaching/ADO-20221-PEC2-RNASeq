...
El resultado se puede guardar en un archivo de texto para su posterior explotación.

```{r writeTopTab1}
write.csv(toptab, file="results/topTable_limmaVoom.csv")
```
...
```{r writeTopTab2}
write.csv(topTags_edge, file="results/topTable_edgeR.csv")
```
