...
png("pheatmap_transp.png", units="in", width=30, height=22, res=600, bg="transparent")
par(bg=NA)
...
## sense transparencia
png("dotplot.png", units="in", width=14, height=9, res=600)
...
ggsave("dotplot_transp.png", width=14, height=9, dpi=300, bg = "transparent")
```
...
png("cnetplot_transp.png", units="in", width=24, height=16, res=600, bg="transparent")
par(bg=NA)
cnetplot(ego2, showCategory=5, cex_category=1, cex_label_category=2.5, 
